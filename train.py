...
class SegmentationNet(nn.Module):
    ...
    def __init__(self, input_dim, num_channels, num_convs, reduction=16):
...
class ImageSegmentation:
    ...
    def __init__(self, input_image_path, max_iter=100, min_labels=3, learning_rate=0.2, use_dxf=True,
    ...
    def _read_image(self):
        ...
        if self.cropper:
            self.image = self._crop_image(self.image)
