...
parser.add_argument('--scribble', action='store_true', default=False,
                    help='use scribbles')
parser.add_argument('--nChannel', metavar='N', default=20, type=int,
...
parser.add_argument('--input', metavar='FILENAME',default='cropped_resized_54 (1).jpeg', type=str,
...
loss_hpy = torch.nn.L1Loss(size_average=mean)
loss_hpz = torch.nn.L1Loss(size_average=mean)
